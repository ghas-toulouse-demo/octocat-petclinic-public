/**
 * Ce classe représente le service API pour l'application Pet Clinic.
 * Il gère les opérations de base de données liées aux propriétaires et aux animaux de compagnie.
 */
